...
public class QueueTheoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearlayout_theory=(LinearLayout)findViewById(R.id.activity_queue_simple_theory_l);
        string_card_title = getResources().getStringArray(R.array.queue_simple_title);
        string_card_text = getResources().getStringArray(R.array.queue_simple_text);
        string_card_text_dis = getResources().getStringArray(R.array.queue_simple_text_dis);
