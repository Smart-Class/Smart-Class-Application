...
public class LinkedListTheoryActivity extends AppCompatActivity {
    View view_card;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linked_list_theory);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        LayoutInflater layoutInflater=LayoutInflater.from(this);
        linearlayout_theory=(LinearLayout)findViewById(R.id.activity_linkedlist_single_theory_l);
        string_card_title = getResources().getStringArray(R.array.linkedlist_single_title);
        string_card_text = getResources().getStringArray(R.array.linkedlist_single_text);
        string_card_text_dis = getResources().getStringArray(R.array.linkedlist_single_text_dis);
